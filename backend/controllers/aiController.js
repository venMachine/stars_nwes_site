...
- **Минимум 2 подзаголовка** (каждый на отдельной строке, 3–20 слов, можно с эмодзи). Пример: «🕯️ Скандал на красной дорожке» или **«Почему они расстались»**.
...
[Абзац: 2-9 предложения с первой порцией фактов + ссылка на источник]
[Абзац: ещё 2-9 предложения, детали, цитаты, реакция]

[ПОДЗАГОЛОВОК 2 (короткий)]

[Абзац: 2-9 предложения с продолжением или другой гранью события + ссылка]
...

{
  ...
  "content": "текст по шаблону выше (минимум 5000 знаков - Это важно!!!!!!!!!, с подзаголовками, с блоком Что в итоге?)",
